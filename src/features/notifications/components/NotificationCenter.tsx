...
const DEFAULT_NOTIFS: Notification[] = [
  ...
  { id: '2', type: 'info',    title: 'Payment Received', message: 'Payment of ₱150 received from Maria Santos',          time: '15 min ago',  read: false },
...
const s = StyleSheet.create({
  ...
  // Header
  header: { backgroundColor: colors.surface, paddingHorizontal: spacing.lg, paddingTop: spacing.lg, paddingBottom: spacing.md, borderTopLeftRadius: 28, borderTopRightRadius: 28 },
  headerTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: spacing.md },
  headerLeft: { flexDirection: 'row', alignItems: 'center', gap: spacing.md },
  bellIconWrap: { width: 48, height: 48, borderRadius: 14, backgroundColor: colors.navy, alignItems: 'center', justifyContent: 'center' },
  ...
  actionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#FFF7ED', borderRadius: 12, paddingVertical: spacing.sm },
  ...
  // Notif card
  notifCard: { backgroundColor: colors.surface, borderRadius: 16, padding: spacing.md, borderWidth: 2, borderColor: 'transparent', gap: spacing.sm },
  notifCardUnread: { borderColor: `${colors.orange}40` },
